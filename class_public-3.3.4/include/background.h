...
struct background
{
    ...
    double sqrt_k_eta0;              /**< \f$ g = \sqrt{-k}\,\eta_0 \f$: GREA curvature parameter */
    double H0_grea;                  /**< Input H0 for the GREA normalisation, before rescaling */
    double grea_alpha;               /**< Derived GREA alpha = g / (E(1) tau(1)) */
    double grea_E1;                  /**< Derived E(1) from the GREA solution */
    int grea_bt_size;                /**< Number of precomputed points in GREA tables */
    double *grea_loga_table;         /**< Log(a) grid for GREA tables */
    double *grea_tau_table;          /**< Dimensionless GREA conformal time tau(a) */
    double *grea_E_table;            /**< Raw GREA E(a) before rescaling */
    double *grea_dE_dloga_table;     /**< dE/dlog(a) for GREA H' evaluation */
    double *grea_w_table;            /**< GREA equation-of-state table */
    double *grea_dw_over_da_table;   /**< GREA dw/da table */
    double *grea_integral_fld_table; /**< GREA integral for rho_fld initial condition */
    int grea_last_index;             /**< Last interpolation index for GREA tables */
